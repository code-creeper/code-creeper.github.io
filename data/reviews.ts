...
export const reviews: Review[] = [{
	client_name: "Fateh",
	feedbacks: [
		"I’ve worked with Abdul on backend, frontend, and even DevOps/server management, and he always delivers beyond expectations. He quickly understands requirements and comes back with clean, smart solutions without needing tons of explanation.\n" +
		"\n" +
	...
	client_name: "Fadi",
	feedbacks: [
		"Abdul is by far the best developer I’ve worked with on Upwork. He consistently delivers high-quality work, communicates clearly, and is extremely reliable.\n" +
		"\n" +
	...
	feedbacks: [
		"Abdul was amazing to work with. he took a complicated set up and made it work perfectly in Laravel and for that I very much appreciate his effort. He is very knowledgeable and very quick and accurate with his work so we wasted no time in getting this done.",
		"Abdul continues to impress me with his skill. He never lets me down and always produces fantastic code.",
	]
}, {
