    ...
    <div class="col-span-7 space-y-4">
      <section id="overview">
        ...
        <p class="text-white/90">
          Capital Club is a program, established by OnMarket, that offers loyal and accredited members exclusive access to private investments, early notifications of deals, and equity crowdfunding (ECF) private deal rooms, including access to early-stage companies. It is mainly focused on entrepreneurs, investors, and business owners to get benefit from its academy and lectures .
        </p>
        <img src="@/assets/images/projects/capitalclub/academy.png" alt="project screenshot" class="w-full rounded-xl px-5"/>
      </section>
      <section id="project-goals">
        <h3 class="heading heading-bl">Project Goals</h3>
        <p class="text-white/90">
          The primary goal of the Capital Club project was to develop a highly reactive, user-friendly, and professional web application that fosters a global network of entrepreneurs. Capital Club now connects over 15,000 members across 72 countries, offering access to exclusive courses, networking events, and a VIP marketplace with discounted products and services.
        </p>
      </section>
      ...
      <section id="features">
        ...
        <img src="@/assets/images/projects/capitalclub/lesson-notes.png" alt="project screenshot" class="w-full rounded-xl px-5"/>

        <h4 class="font-bold text-white">Favourite lessons and notes</h4>
        <img src="@/assets/images/projects/capitalclub/favourite.png" alt="project screenshot" class="w-full rounded-xl px-5"/>

        <h4 class="font-bold text-white">Profile Management</h4>
        <img src="@/assets/images/projects/capitalclub/profile.png" alt="project screenshot" class="w-full rounded-xl px-5"/>

        <h4 class="font-bold text-white">Discord Integration</h4>
        <img src="@/assets/images/projects/capitalclub/discord.png" alt="project screenshot" class="w-full rounded-xl px-5"/>
      ...
      <section id="initiatives">
        ...
        <p class="text-white/90">
          To overcome the challenges encountered during the project, the team implemented several strategic initiatives. Adopting an agile methodology allowed for iterative development and rapid response to changing requirements, enhancing flexibility and collaboration among team members. Implementing a continuous delivery pipeline enabled automated testing and deployment, ensuring swift and reliable releases while maintaining high-quality standards. Embracing a microservices architecture facilitated modular development, allowing individual components to be developed, tested, and deployed independently, thereby improving scalability and maintainability. Additionally, integrating DevOps practices fostered a culture of shared responsibility between development and operations teams, streamlining processes and reducing deployment times. These combined efforts were pivotal in delivering a robust, user-friendly, and professional web application that met both user expectations and business objectives.
        </p>
        <img src="@/assets/images/projects/capitalclub/logo.png" alt="project screenshot" class="w-full rounded-xl px-5"/>
      </section>
    </div>
